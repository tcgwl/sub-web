...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "trojanhou.vercel.app (trojanhou自用）": "https://trojanhou.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://trojanhou.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://trojanhou.vercel.app/sub?";
